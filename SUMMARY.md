  ...
  * [V3 (Current)](insights/v3-current/README.md)
    ...
    * [Getting Started](insights/v3-current/getting-started/README.md)
      ...
      * [Dashboard Overview](insights/v3-current/getting-started/dashboard-overview/README.md)
        ...
        * [COCOMO: Cost Estimation Simplified](insights/v3-current/getting-started/dashboard-overview/cocomo-cost-estimation-simplified.md)
    ...
    * [Project Overview Page](insights/v3-current/project-overview-page/README.md)
      * [Filter the Date Range](insights/v3-current/project-overview-page/filter-the-date-range.md)
      * [Key Metrics and detailed Analysis](insights/v3-current/project-overview-page/key-metrics-and-detailed-analysis/README.md)
        * [Contributor](insights/v3-current/project-overview-page/key-metrics-and-detailed-analysis/contributor.md)
        * [Commits](insights/v3-current/project-overview-page/key-metrics-and-detailed-analysis/commits.md)
        * [Issues](insights/v3-current/project-overview-page/key-metrics-and-detailed-analysis/issues.md)
        * [Pull Requests](insights/v3-current/project-overview-page/key-metrics-and-detailed-analysis/pull-requests.md)
        * [Forks](insights/v3-current/project-overview-page/key-metrics-and-detailed-analysis/forks.md)
        * [Stars](insights/v3-current/project-overview-page/key-metrics-and-detailed-analysis/stars.md)
      * [Contributor Leaderboard](insights/v3-current/project-overview-page/contributor-leaderboard/README.md)
        * [Activities Types](insights/v3-current/project-overview-page/contributor-leaderboard/activities-types.md)
      * [Best Practice Score](insights/v3-current/project-overview-page/best-practice-score/README.md)
        * [Checks](insights/v3-current/project-overview-page/best-practice-score/checks/README.md)
          * [Documentation Checks](insights/v3-current/project-overview-page/best-practice-score/checks/documentation-checks.md)
          * [Best Practices Checks](insights/v3-current/project-overview-page/best-practice-score/checks/best-practices-checks.md)
          * [Security Checks](insights/v3-current/project-overview-page/best-practice-score/checks/security-checks.md)
          * [Legal Checks](insights/v3-current/project-overview-page/best-practice-score/checks/legal-checks.md)
        * [Calculating Global Score](insights/v3-current/project-overview-page/best-practice-score/calculating-global-score.md)
      * [Geographical Distribution](insights/v3-current/project-overview-page/geographical-distribution.md)
      * [Active Days](insights/v3-current/project-overview-page/active-days.md)
      * [Contributor Dependency](insights/v3-current/project-overview-page/contributor-dependency.md)
      * [Organization Dependency](insights/v3-current/project-overview-page/organization-dependency.md)
      * [Organization Leaderboard](insights/v3-current/project-overview-page/organization-leaderboard.md)
      * [Work Time Distribution](insights/v3-current/project-overview-page/work-time-distribution.md)
    ...
    * [Reports](insights/v3-current/reports.md)
      * [Contributors Reports](insights/v3-current/reports/contributors-reports.md)
      * [Organizations Reports](insights/v3-current/reports/organizations-reports.md)
      * [Activities](insights/v3-current/reports/activities.md)
      * [Retention](insights/v3-current/reports/retention.md)
...
* [Project Control Center](project-control-center/README.md)
  * [V2 (Current)](project-control-center/v2-current/README.md)
    * [Release Notes](project-control-center/v2-current/release-notes.md)
    * [Overview](project-control-center/v2-current/overview.md)
    * [PCC Dashboard](project-control-center/v2-current/pcc-dashboard.md)
    ...
    * [Collaborations](project-control-center/v2-current/collaborations/README.md)
      ...
      * [Meetings](project-control-center/v2-current/collaborations/meetings.md)
      * [Mailing List](project-control-center/v2-current/collaborations/mailing-list.md)
      * [Wiki](project-control-center/v2-current/collaborations/wiki.md)
      * [Issue Tracker](project-control-center/v2-current/collaborations/issue-tracker.md)
      * [Surveys](project-control-center/v2-current/collaborations/surveys.md)
  * [V1 (Deprecated)](project-control-center/v1-deprecated/README.md)
    * [Release Notes](project-control-center/v1-deprecated/release-notes/README.md)
      * [PCC V1.6.6 Release](project-control-center/v1-deprecated/release-notes/pcc-v1.6.6-release.md)
      * [PCC V1.6.5 Release](project-control-center/v1-deprecated/release-notes/pcc-v1.6.5-release.md)
      * [PCC V1.6.4 Release](project-control-center/v1-deprecated/release-notes/pcc-v1.6.4-release.md)
      * [PCC V1.6.3 Release](project-control-center/v1-deprecated/release-notes/pcc-v1.6.3-release.md)
      * [PCC V1.6.0 Release](project-control-center/v1-deprecated/release-notes/pcc-v1.6.0-release.md)
      * [PCC V1.5.1 Release](project-control-center/v1-deprecated/release-notes/pcc-v1.5.1-release.md)
      * [PCC - V1.4 Release](project-control-center/v1-deprecated/release-notes/pcc-v1.4-release.md)
      * [PCC - June 28/2022 Release](project-control-center/v1-deprecated/release-notes/pcc-june-28-2022-release.md)
      * [PCC - April 20/2022 Release](project-control-center/v1-deprecated/release-notes/pcc-april-20-2022-release.md)
      * [PCC - March 15/2022 Release](project-control-center/v1-deprecated/release-notes/pcc-march-15-2022-release.md)
    * [Overview](project-control-center/v1-deprecated/overview.md)
    * [PCC Dashboard](project-control-center/v1-deprecated/pcc-dashboard.md)
    * [Role-Based Access Control](project-control-center/v1-deprecated/role-based-access-control/README.md)
      * [Roles and Permissions for Project Setup](project-control-center/v1-deprecated/role-based-access-control/roles-and-permissions-for-project-setup.md)
      * [Roles and Permissions for IT Services](project-control-center/v1-deprecated/role-based-access-control/roles-and-permissions-for-it-services.md)
    * [Adding a Main Project](project-control-center/v1-deprecated/adding-a-main-project.md)
    * [Operations for a Project](project-control-center/v1-deprecated/setup-services-for-a-project/README.md)
      * [Project Definition for a Project](project-control-center/v1-deprecated/setup-services-for-a-project/basic-setup-for-a-project.md)
      * [Legal Setup for a Project](project-control-center/v1-deprecated/setup-services-for-a-project/legal-setup-for-a-project.md)
      * [Membership Setup for a Project](project-control-center/v1-deprecated/setup-services-for-a-project/membership-setup-for-a-project.md)
      * [Setting up a Domain for a Project](project-control-center/v1-deprecated/setup-services-for-a-project/setting-up-a-domain-for-a-project.md)
      * [Cloud Providers](project-control-center/v1-deprecated/setup-services-for-a-project/cloud-providers.md)
    * [Collaboration Services for a Project](project-control-center/v1-deprecated/it-services-for-a-project/README.md)
      * [Committees Setup for a Project](project-control-center/v1-deprecated/it-services-for-a-project/committees-setup-for-a-project.md)
      * [Mailing List](project-control-center/v1-deprecated/it-services-for-a-project/mailing-list.md)
      * [Issue Tracker for a Project](project-control-center/v1-deprecated/it-services-for-a-project/issue-tracking-for-a-project.md)
      * [Setting up Wiki](project-control-center/v1-deprecated/it-services-for-a-project/setting-up-wiki.md)
      * [Meeting Management](project-control-center/v1-deprecated/it-services-for-a-project/meetings.md)
    * [Development](project-control-center/v1-deprecated/development/README.md)
      * [Source Control](project-control-center/v1-deprecated/development/source-control.md)
    * [LFX Tools](project-control-center/v1-deprecated/tools/README.md)
      * [Insights](project-control-center/v1-deprecated/tools/insights/README.md)
        * [Connecting GitHub](project-control-center/v1-deprecated/tools/insights/connecting-github.md)
        * [Connecting Gerrit](project-control-center/v1-deprecated/tools/insights/connecting-gerrit.md)
      * [Security](project-control-center/v1-deprecated/tools/security/README.md)
        * [Onboarding Projects from GitHub](project-control-center/v1-deprecated/tools/security/onboarding-projects-from-github.md)
        * [Manage Vulnerabilities](project-control-center/v1-deprecated/tools/security/manage-vulnerabilities.md)
        * [Manage False Positives](project-control-center/v1-deprecated/tools/security/manage-false-positives/README.md)
          * [Regular Expressions Cheat Sheet](project-control-center/v1-deprecated/tools/security/manage-false-positives/regular-expressions-cheat-sheet.md)
          * [Ignore.yml File](project-control-center/v1-deprecated/tools/security/manage-false-positives/ignore.yml-file.md)
        * [Manage Non Inclusive Naming](project-control-center/v1-deprecated/tools/security/manage-non-inclusive-naming.md)
      * [EasyCLA](project-control-center/v1-deprecated/tools/easycla.md)
