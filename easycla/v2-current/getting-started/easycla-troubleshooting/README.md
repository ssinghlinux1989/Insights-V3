...
* Ensure that your commits are [linked to your GitHub account](https://docs.github.com/en/github/committing-changes-to-your-project/why-are-my-commits-linked-to-the-wrong-user#commits-are-not-linked-to-any-user). If your commits are not linked to any GitHub user, GitHub will display the _grey Octocat logo_ ![](broken-reference)beside the commits.
...
![Pull Request Commenting](broken-reference)
...
![Comment /easycla in the Pull Request](broken-reference)
