...
The Linux Foundation is a technology association of several companies that helps scale open source projects. The Linux Foundation provides platforms to support the sustainability of the open source ecosystem by providing various services, events, and training.
...
Simply log into \[Project Control Center] using your Linux Foundation account and follow the step-by-step instructions. The application process takes just a few minutes, then your submission will be reviewed by the LFX team. You’ll receive communication from us once your project has been set up.
